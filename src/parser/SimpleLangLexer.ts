...
export class SimpleLangLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(SimpleLangLexer._LITERAL_NAMES, SimpleLangLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(SimpleLangLexer._ATN, this);
	}
	...
	// @Override
	public get serializedATN(): string { return SimpleLangLexer._serializedATN; }
	...
	public static readonly _serializedATN: string =
		...
		"\x02\x13\x14\x07,\x02\x02\x14\x04\x03\x02\x02\x02\x15\x16\x071\x02\x02" +
	...
	public static get _ATN(): ATN {
		if (!SimpleLangLexer.__ATN) {
			SimpleLangLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(SimpleLangLexer._serializedATN));
		}
